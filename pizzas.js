let pizzaJson = [
    ...
    {id:8, name:'Paracatu', img:'images/pizza8.png', price:20.36, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    {id:9, name:'California', img:'images/pizza9.png', price:19.99, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    {id:10, name:'Bacon', img:'images/pizza10.png', price:21.99, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'}
];